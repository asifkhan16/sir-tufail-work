                ...
                <?php
                  foreach ($students_arr as $key => $value) { ?>
                    <tr>
                      ...
                      <td>
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-id="<?php echo $value->student_id; ?>">Update</button>
                      </td>
                    </tr>
                  <?php } ?>
              </tbody>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label>Reg#</label>
              <input type="text" name="reg_no" class="form-control" value="">
            </div>
            <div class="form-group">
              <label>Class</label>
              <select class="form-control" name="class_id">
